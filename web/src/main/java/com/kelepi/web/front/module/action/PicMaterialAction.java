...
public class PicMaterialAction extends BaseAction{
    ...
    public void doSave(@FormGroup("uploadPicMaterial") PicMaterialDO picMaterialDO, @Param("referer")String referer, Navigator nav, TurbineRunData rundata, Context context) {

       picMaterialAO.save(picMaterialDO);

       nav.redirectToLocation(getTurbineURIBroker("jokeModule").setTarget("picMaterialUpload.vm").render());
    }
