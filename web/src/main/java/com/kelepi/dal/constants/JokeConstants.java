...
/*   public static final String TEM_DIR = "k:/img/tmp/";
   public static final String MSYHBD = "k:/msyhbd.ttf";
    public static final String MSYH = "k:/msyh.ttf";
    public static final String JOKE_HEAD_IMAGE = "k:/img/head.jpg";
    public static final String JOKE_FOOTER_IMAGE = "k:/img/footer.jpg";
